...
export default function Toggle({ deletePost, setToggle }: ToggleProps) {
  const modal =
    "absolute bg-white top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 p-12 rounded-lg flex flex-col gap-6";
  return (
    <div
    ...
    >
      <div className={modal}>
        ...
        <button
          onClick={() => deletePost()}
          className="bg-red-600 text-sm text-white py-2 px-2"
        >
          Delete Post
        </button>
      </div>
